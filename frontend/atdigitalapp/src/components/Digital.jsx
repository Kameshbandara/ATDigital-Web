...
export default function Digital() {
  return (
    ...
    viewport={{ once: true }}
      ...
      className='flex flex-col lg:flex-row items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden gap-1 lg:gap-2' id='Digital'>
      
      {/* Content on left side */}
      <div className='flex-1 flex flex-col items-start order-2 lg:order-1 lg:pl-36'>
